...
async function update(ctx) {
  ...
  user[config.passport.fields.givenName] = body[config.passport.fields.givenName];
  user[config.passport.fields.familyName] = body[config.passport.fields.familyName];
...
module.exports = {
  list, retrieve, update, remove, login,
};
